/* eslint-disable */
// Generated by Wrangler by running `wrangler types cloudflare/site/src/worker-configuration.d.ts` (hash: f60265fe0eca1e5da931f48f6894ffa2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "XSXB_ADMIN_SESSION_MINUTES" | "XSXB_ADMIN_USERNAME" | "XSXB_EMAIL_FROM">> {}
}
