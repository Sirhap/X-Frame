(function attachFrameOrganizerText(root, factory) {
  ...
  const TEXT = {
    zh: {
      ...
      browserImportSubtitle: "导入 → 浏览器内排序 / 删帧 / 抠图 → 下载动画 ZIP",
      importSetupTitle: "导出信息",
      importSetupHint: "图片先在浏览器本地处理，确认后写入所选项目。",
      browserImportSetupHint: "图片和视频只在当前浏览器处理；确认后直接下载动画 ZIP。",
      importProject: "保存到",
    ...
    en: {
      ...
      browserImportSubtitle: "Import → process locally in your browser → download animation ZIP",
      ...
      browserImportSetupHint:
        "Images and videos stay in this browser session; confirmation downloads an animation ZIP.",
