(function attachFrameOrganizerText(root, factory) {
  ...
  const TEXT = {
    zh: {
      ...
      importTitle: "导入与处理动画",
      importSubtitle: "导入 → 排序 / 删帧 / 抠图 → 创建动画",
      ...
      emptyWorksetHint: "从上方选择图片序列或视频；导入后才会显示整理、分析与删除工具。",
    ...
    en: {
      ...
      importSubtitle: "Import → reorder / remove / cut out → create animation",
      ...
      emptyWorksetHint:
        "Choose an image sequence or video above. Editing, analysis, and removal tools appear after import.",
