(function attachBatchCutoutText(root, factory) {
  ...
  const TEXT = {
    zh: {
      ...
      advancedUnset: "未设置",
      advancedWindow: "{alphaLow} — {alphaHigh} / T {alphaThreshold}",
      ...
      blurRadius: "柔化半径",
      postHint: "边缘颜色恢复用于修正主体残色；背景搜索半径仅在恢复强度大于 0 时生效。",
      alphaLow: "半透明低阈值",
      alphaHigh: "半透明高阈值",
    ...
    en: {
      ...
      toleranceClosedHint:
        "Tolerance -1 is the off/closed stop: matching is off, pixels do not move, and the processor does not auto-estimate a tolerance.",
      ...
      postHint:
        "Edge recovery corrects subject spill; background search activates above zero recovery strength.",
      alphaLow: "Alpha low",
