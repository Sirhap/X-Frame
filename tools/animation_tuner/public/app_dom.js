(function attachXFrameAppDom(root, factory) {
  "use strict";

  const api = factory(root);
  if (typeof module === "object" && module.exports) module.exports = api;
  if (root) root.XFrameAppDom = api;
  ...
  function createElements(documentRef = root.document) {
    ...
    return {
      ...
      appConfirmAlternate: documentRef.querySelector("#appConfirmAlternate"),
      ...
      groupFilterField: documentRef.querySelector("#groupFilterField"),
