...
const UTF8_TEXT_TYPES = [/^text\//i, /^application\/(?:json|javascript|xml|xhtml\+xml|svg\+xml)(?:\s*;|$)/i];
...
function withUtf8Charset(contentType = "application/json") {
  ...
  return UTF8_TEXT_TYPES.some((pattern) => pattern.test(value)) ? `${value}; charset=utf-8` : value;
}
