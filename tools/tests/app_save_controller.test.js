...
test("save locks before asynchronous preparation and shares the active request", async () => {
  let releaseAudio;
  ...
  const concurrentSave = fixture.controller.save();
  assert.equal(concurrentSave, firstSave);
