...
test("premium tuner detection ignores collision boxes generated only for preview defaults", () => {
  assert.deepEqual(
    premium.detectTunerFeatures({
      frameBoxOverrides: {
        "hero:0": {
          autoGenerated: true,
          collisionbox: { offset: { x: 0, y: 0 }, size: { x: 10, y: 20 }, enabled: true },
        },
      },
    }),
    [],
  ...
  assert.deepEqual(
    premium.detectTunerFeatures({
      frameBoxOverrides: {
        "hero:0": {
          collisionbox: { offset: { x: 1, y: 0 }, size: { x: 10, y: 20 }, enabled: true },
        },
      },
    }),
